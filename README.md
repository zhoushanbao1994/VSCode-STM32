...
![image-20210302140202948](/image-20210302140202948.png)
...
- ![image-20210302141811489](/image-20210302141811489.png)
- 这样在git bash窗口下就可以使用make了
- ![image-20210302142012900](/image-20210302142012900.png)

## 1.3 设置环境变量

把Arm工具链安装目录下的bin文件夹和openOCD安装目录下的bin文件夹都添加到PATH环境变量中。

![image-20210302142236653](/image-20210302142236653.png)

添加完后，重启电脑，在Win命令行和git bash中分别测试，若看到版本信息则说明设置成功。

![image-20210302142522724](/image-20210302142522724.png)
...
![image-20210302132232746](/image-20210302132232746.png)

“**通用串行总线控制器**”，OpenOCD识别不到。

插上Jlink后，打开Zadig，选择"Options"---"List All Devices"，下拉菜单中选择"J-link"，然后在右侧选择"WinUSB"，点击Reinstall Driver。

![image-20210302131826587](/image-20210302131826587.png)

![image-20210302132411483](/image-20210302132348826.png)

打开设备管理器，就看到J-link从**“通用串行总线控制器”**变成了**“通用串行总线设备”**。这样就修改完成了。

![image-20210302132502379](/image-20210302132502379.png)
...
![image-20210302143457105](/image-20210302143457105.png)

**项目配置:** Project Manager - Project， “Toolchain/IDE”选择生成makefile即可

![image-20210302143926455](/image-20210302143926455.png)

**代码生成器配置：**Project Manager - Code Generator， 勾选选项。

![image-20210302144137453](/image-20210302144137453.png)

### 2.1.3 生成代码

点击右上角的GENERATE CODE生成代码。

![image-20210302144740877](/image-20210302144740877.png)

## 2.2 配置VS Code

用VS Code打开工程文件夹，你将会看到这样的目录结构:

![image-20210302144911076](/image-20210302144911076.png)

### 2.2.1. 安装VS Code 插件

按 F1 输入 extensions:

![image-20210302145307629](/image-20210302145307629.png)

![image-20210302145405813](/image-20210302145405813.png)
...
![image-20210302145829028](/image-20210302145829028.png)
...
![image-20210302150035037](/image-20210302150035037.png)
...
![image-20210302150434830](/image-20210302150434830.png)
...
![image-20210302150951229](/image-20210302150951229.png)

使用c_cpp_properties.json配置文件，用来告诉VS Code我们定义了这些宏。

a. 随便找到一处红色波浪线，点击并把光标移到那一行，左上角会出现一个黄色小灯泡。点击黄色小灯泡并选择“编辑‘includePath设置’”。

![image-20210302151130764](/image-20210302151130764.png)

![image-20210302151158941](/image-20210302151158941.png)
...
![image-20210302153959030](/image-20210302153959030.png)
...
![image-20210302153854369](/image-20210302153854369.png)
...
![image-20210302154440004](/image-20210302154440004.png)

## 3.4 测试使用

直接按F5，或者左边的Debug按钮：![image-20210302154538413](/image-20210302154538413.png)，点击运行：![image-20210302154607782](/image-20210302154607782.png)